...
public class AppUserController {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Suceess|OK", response = Iterable.class),
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Suceess|OK", response = AppUser.class),
			@ApiResponse(code = 401, message = "not authorized!"), @ApiResponse(code = 403, message = "forbidden!!!"),
			@ApiResponse(code = 404, message = "not found!!!") })
